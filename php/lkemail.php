...
<body>
    <div class="wrapper">
      ...
      <div class="container">
        <div class="content-faq" style="text-align: center; font-size: 30px">
    ...
    <form action="form.php" method="post" name="forma">
        <p style="color: #fff; padding-bottom:20px; font-size:28px" >Почта успешно добавлена</p>
        <input type="text" name="email" class="form-control"><br/>
        <br/>
           <input class="buy-button" id="submit" type="submit" value="Добавить"><br/>
    </form>
            
    <div style="color: #fff; padding-top:50px; font-size:28px" >
        <p>Вы подписались на новостную рассылку. <br/>
        Теперь на ваш email будет поступать информация о заказах и новости сайта,<br/>
        такая как акции, появление новых читов и расширение каталога,<br/>
        чтобы вы всегда были в курсе, что нового на сайте.
         </p>
    </div>

    <form class="mt-5" method="post" action="do_logout.php">
        <button type="submit" class="buy-button" style="margin-top:20px;">Выйти</button>
    </form>
